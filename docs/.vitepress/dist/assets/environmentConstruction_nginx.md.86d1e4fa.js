...
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><h1 id="_4\u3001\u590D\u6742\u5B89\u88C5" tabindex="-1">4\u3001\u590D\u6742\u5B89\u88C5</h1><p>\u76F8\u5F53\u4E8E\u5728configure\u4E0A\u505A\u4E00\u4E9B\u547D\u4EE4\u7684\u6DFB\u52A0</p><p>\u6CE8\u610F\uFF1A\u8981\u91CD\u65B0\u6DFB\u52A0configure\u540E\u9762\u8DDF\u7684\u540E\u7F00\u5F97\u5378\u8F7Dng\u540E\u91CD\u65B0\u5B89\u88C5</p><div class="language-shell line-numbers-mode"><pre><code>./configure --prefix<span class="token operator">=</span>/usr/local/nginx --with-http_ssl_module --with-openssl<span class="token operator">=</span>/usr/cxy/openssl-1.1.1l
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br></div></div><h1 id="_5\u3001\u5378\u8F7Dnginx" tabindex="-1">5\u3001\u5378\u8F7Dnginx</h1><p>1\u3001<code>./nginx -s stop</code> \u5148\u628Ang\u505C\u6389</p><p>2\u3001<code>rm -rf /usr/local/nginx</code> \u5C06ng\u5220\u9664</p><p>3\u3001<code>make clean</code> \u5C06\u5B89\u88C5\u5305\u4E4B\u524D\u7F16\u8BD1\u7684\u73AF\u5883\u6E05\u9664\u6389</p><h1 id="_6\u3001\u65E0\u505C\u6B62\u670D\u52A1\u66F4\u65B0nginx\u7248\u672C" tabindex="-1">6\u3001\u65E0\u505C\u6B62\u670D\u52A1\u66F4\u65B0nginx\u7248\u672C</h1><p>1)\u3001\u5C06\u65E7\u7248\u672C\u7684nginx\u4E0Bsbin\u7684nginx\u8FDB\u884C\u5907\u4EFD</p><div class="language-shell line-numbers-mode"><pre><code><span class="token builtin class-name">cd</span> /usr/local/nginx/sbin
...
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br></div></div><h1 id="_7\u3001nginx\u670D\u52A1\u5668\u5347\u7EA7" tabindex="-1">7\u3001nginx\u670D\u52A1\u5668\u5347\u7EA7</h1><p>\u65B9\u6848\u4E00\u3001\u4F7F\u7528nginx\u670D\u52A1\u4FE1\u606F\u5347\u7EA7</p><p>\u5982\u4E0A6</p><p>\u65B9\u6848\u4E8C\u3001\u4F7F\u7528nginx\u5B89\u88C5\u76EE\u5F55\u7684make\u547D\u4EE4\u5347\u7EA7</p><p>1)\u3001\u5C06\u65E7\u7248\u672C\u7684nginx\u4E0Bsbin\u7684nginx\u8FDB\u884C\u5907\u4EFD</p><div class="language-shell line-numbers-mode"><pre><code><span class="token builtin class-name">cd</span> /usr/local/nginx/sbin
<span class="token function">mv</span> nginx nginxold
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>2)\u3001\u5C06\u65B0\u7248\u672C\u7684\u5B89\u88C5\u76EE\u5F55\u7F16\u8BD1\u540E\u7684objs\u76EE\u5F55\u4E0B\u7684nginx\u6587\u4EF6\u62F7\u8D1D\u5230\u539F\u6765 <code>/usr/local/nginx/sbin</code> \u76EE\u5F55\u4E0B</p><div class="language-shell line-numbers-mode"><pre><code><span class="token builtin class-name">cd</span> ~/nginx/newVersion/nginx-1.16.1/objs
<span class="token function">cp</span> nginx /usr/local/nginx/sbin
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>3)\u3001\u8FDB\u5165\u5230\u5B89\u88C5\u76EE\u5F55\uFF08\u6CE8\u610F\u518Dnginx\u76EE\u5F55\u4E0B \u800C\u4E0D\u662Fsbin\u76EE\u5F55\u4E0B\uFF09\uFF0C\u6267\u884Cmake upgrade</p><p>4)\u3001\u9A8C\u8BC1 nginx -V</p><h1 id="_8\u3001user\u6307\u4EE4" tabindex="-1">8\u3001user\u6307\u4EE4</h1><p>\u7528\u4E8E\u914D\u7F6E\u8FD0\u884Cnginx\u670D\u52A1\u5668\u7684worker\u8FDB\u7A0B\u7684\u7528\u6237\u548C\u7528\u6237\u7EC4</p><div class="language-"><pre><code>useradd www   \u4F1A\u5728home\u76EE\u5F55\u4E0B\u521B\u5EFA\u4E00\u4E2Awww\u7684\u7528\u6237
...
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><h1 id="_9\u3001work\u8FDB\u7A0B\u548Cmaster\u8FDB\u7A0B" tabindex="-1">9\u3001work\u8FDB\u7A0B\u548Cmaster\u8FDB\u7A0B</h1><p>\u5982\u679C\u8981\u5173\u95EDwork\u8FDB\u7A0B</p><div class="language-nginx line-numbers-mode"><pre><code><span class="token comment"># user  nobody;         	# \u7528\u6237\u7EC4</span>
...
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br></div></div><h1 id="_9\u3001ng\u5E38\u4F7F\u7528\u7684\u4E00\u4E9B\u547D\u4EE4" tabindex="-1">9\u3001ng\u5E38\u4F7F\u7528\u7684\u4E00\u4E9B\u547D\u4EE4</h1><div class="language-shell line-numbers-mode"><pre><code><span class="token function">ps</span> -ef <span class="token operator">|</span> <span class="token function">grep</span> nginx   \u8FC7\u6EE4\u51FA\u5173\u4E8Eng\u7684\u8FDB\u7A0B\u4FE1\u606F
./nginx -t  \u68C0\u67E5config\u914D\u7F6E\u6587\u4EF6\u662F\u5426\u6709\u9519
./nginx -T  \u68C0\u67E5config\u914D\u7F6E\u6587\u4EF6\u662F\u5426\u6709\u9519\u5E76\u6253\u5370\u51FA\u914D\u7F6E\u6587\u4EF6
./nginx -tq \u68C0\u67E5config\u914D\u7F6E\u6587\u4EF6\u662F\u5426\u6709\u9519\u5E76\u6253\u5370\u51FA\u914D\u7F6E\u6587\u4EF6\u4E2D\u51FA\u9519\u7684\u4F4D\u7F6E\u548C\u9519\u8BEF
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><h2 id="\u9000\u51FAng\u8FDB\u7A0B" tabindex="-1">\u9000\u51FAng\u8FDB\u7A0B</h2><div class="language-shell line-numbers-mode"><pre><code><span class="token function">ps</span> -ef <span class="token operator">|</span> <span class="token function">grep</span> nginx 		\u62FF\u5230\u8FDB\u7A0B\u53F7
...
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><h1 id="\u53CD\u5411\u4EE3\u7406" tabindex="-1">\u53CD\u5411\u4EE3\u7406</h1><h2 id="\u4EE3\u7406\u659C\u6760\u95EE\u9898" tabindex="-1"><strong>\u4EE3\u7406\u659C\u6760\u95EE\u9898</strong></h2><p><strong>1.\u4EE5\u4E0B\u662F\u52A0\u4E0D\u52A0\u659C\u6760\u90FD\u662F\u4E00\u6837\u7684\u8DEF\u5F84</strong> \u90FD\u4F1A\u8BBF\u95EE <code>http://10.142.124.221:18080/</code></p><div class="language-nginx line-numbers-mode"><pre><code><span class="token directive"><span class="token keyword">server</span></span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><h2 id="\u91CD\u590D\u51FA\u73B0\u591A\u6B21\u8DE8\u57DF\u5141\u8BB8" tabindex="-1">\u91CD\u590D\u51FA\u73B0\u591A\u6B21\u8DE8\u57DF\u5141\u8BB8*</h2><p>\u53EF\u4EE5\u4F7F\u7528<code>proxy_set_header Origin &quot;&quot;;</code>\u5C06\u4EE3\u7406\u6E90\u7684\u5141\u8BB8\u6240\u6709\u8DE8\u57DF\u6E05\u9664\u6389 \u7136\u540E\u518D\u81EA\u5DF1\u8BBE\u7F6E\u4E0A</p><h1 id="linux-ssl\u81EA\u7B7E\u8BC1\u4E66-nginx-\u5C06http\u5347\u7EA7\u6210https" tabindex="-1">linux+ssl\u81EA\u7B7E\u8BC1\u4E66+nginx \u5C06http\u5347\u7EA7\u6210https</h1><p>nginx \u9700\u8981\u5F00\u542F ssl\u6A21\u5757</p><p>\u6267\u884C\u5982\u4E0B\u547D\u4EE4</p><div class="language-nginx line-numbers-mode"><pre><code>./configure --prefix=/usr/local/nginx --with-http_stub_status_module --with-http_ssl_module --with-openssl=/usr/cxy/ssl/openssl-1.1.1
...
<span class="token directive"><span class="token keyword">ssl_certificate_key</span>  server.key</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>ng\u5B8C\u6574\u914D\u7F6E\u5982\u4E0B\uFF1A</p><div class="language-shell line-numbers-mode"><pre><code>control <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br></div></div><h1 id="\u6162\u6162\u5B8C\u5584\u914D\u7F6E\u6587\u4EF6" tabindex="-1">\u6162\u6162\u5B8C\u5584\u914D\u7F6E\u6587\u4EF6</h1><div class="language-nginx line-numbers-mode"><pre><code><span class="token directive"><span class="token keyword">server</span></span> <span class="token punctuation">{</span>
